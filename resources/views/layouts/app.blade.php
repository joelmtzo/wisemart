        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <h1 class="text-2xl font-bold">Wisemart <span class="text-yellow-500 text-2xl font-bold">*</span>
                    </h1>
                </div>
                <div class="relative">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <button class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                            ...
                            <span
                                class="absolute -top-2 -right-2 bg-yellow-400 text-black text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">3</span>
                        </button>
                    </div>
                </div>
            </div>
